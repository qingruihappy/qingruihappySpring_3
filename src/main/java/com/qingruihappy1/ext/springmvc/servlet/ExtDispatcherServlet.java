package com.qingruihappy1.ext.springmvc.servlet;
...
import com.qingruihappy1.utils.ClassUtil;
...
public class ExtDispatcherServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		// 1.获取当前包下的所有的类
		List<Class<?>> classes = ClassUtil.getClasses("com.qingruihappy1.controller");
